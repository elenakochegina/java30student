...
public class StudentController {
	...
	public StudentResponseDto deleteStudent(@PathVariable int id) {
		return studentService.deleteStudent(id);
	}
	
	@PutMapping("/student/{id}")
	public StudentDto updateStudent(@PathVariable int id, @RequestBody StudentUpdateDto studentUpdateDto) {
		return studentService.updateStudent(id, studentUpdateDto);
	}
	
	@PutMapping("/score/student/{id}")
	public boolean addScoreToStudent(@PathVariable int id, @RequestBody ScoreDto scoreDto) {
